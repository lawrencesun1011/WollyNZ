  ...
  return (
    <main className="min-h-screen bg-bg">
      ...
      <section className="mx-auto max-w-5xl px-4 py-10">
        <h2 className="mb-6 text-center text-xl font-bold text-ink">如何运作</h2>
        <div className="grid gap-4 sm:grid-cols-3">
          {STEPS.map((s, i) => (
            <div key={s.title} className="glass rounded-2xl border border-white/60 p-5">
      ...
      {/* 合作物业公司 */}
      <section className="mx-auto max-w-5xl px-4 py-10">
        <h2 className="mb-2 text-center text-xl font-bold text-ink">合作物业公司</h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {PARTNERS.map((p) => (
            <div
              key={p.name}
              className="flex items-center gap-3 rounded-2xl border border-stroke/60 bg-white/60 p-4"
            >
      ...
      <section className="mx-auto max-w-3xl px-4 py-10">
        <div className="glass flex flex-col items-center gap-2 rounded-3xl border border-white/60 p-8 text-center">
